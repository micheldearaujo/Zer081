...
This sale data is a fake, random generated data.
The objective is to create a automatic report fom this particular data.
...
def config_email(image_name):
    ...
    text = MIMEText('Opa meu amigo aqui está o relatório diário das suas vendas')
    msg.attach(text)
